            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-widget pr-60">
                        <div class="footer-logo ">
                            <a href="index.php"><img src="img/f_logo.png" alt="eduhome"></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 pt-4 pt-lg-0">
                    <div class="single-widget">
                        <h3>Our Gallery</h3>
                        <div class="row">
                            <div class="col-6"><a href="gallery.php"><img src="img/image1.png" class="img-fluid pb-2" alt=""></a></div>
                            <div class="col-6"><a href="gallery.php"> <img src="img/image2.png" class="img-fluid pb-2" alt=""></a></div>
                            <div class="col-6"><a href="gallery.php"> <img src="img/image6.png" class="img-fluid pb-2" alt=""></a></div>
                            <div class="col-6"><a href="gallery.php"> <img src="img/image3.png" class="img-fluid pb-2" alt=""></a></div>
                            <div class="col-6"><a href="gallery.php"> <img src="img/image4.png" class="img-fluid pb-2" alt=""></a></div>
                            <div class="col-6"><a href="gallery.php"> <img src="img/image5.png" class="img-fluid pb-2" alt=""></a></div>
                        </div>
                    </div>
                </div>
            </div>
